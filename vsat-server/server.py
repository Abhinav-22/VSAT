...
def get_safeweb():
    ...
    result = driver.find_element(By.XPATH, '//*[@id="bodyContent"]/div/div/div[3]/div[1]/div[1]/div[2]/div[1]/div/b')
...
def get_phishtank():
    ...
    submit = driver.find_element(By.XPATH, '//*[@id="maincol"]/div/div[2]/form/p/input[2]')
    submit.click()
    time.sleep(3)

    try:
        submit = driver.find_element(By.XPATH, '//*[@id="history"]/table[1]/tbody/tr/td[2]/h3/b')
        ...
        if submit.text == "" :
            ...
            submit = driver.find_element(By.XPATH, '//*[@id="maincol"]/div/div[2]/form/p/b/tt')
