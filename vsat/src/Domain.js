  ...
  <path d="M15 .5a.5.5 0 0 0-.724-.447l-8 4A.5.5 0 0 0 6 4.5v3.14L.342 9.526A.5.5 0 0 0 0 10v5.5a.5.5 0 0 0 .5.5h9a.5.5 0 0 0 .5-.5V14h1v1.5a.5.5 0 0 0 .5.5h3a.5.5 0 0 0 .5-.5V.5ZM2 11h1v1H2v-1Zm2 0h1v1H4v-1Zm-1 2v1H2v-1h1Zm1 0h1v1H4v-1Zm9-10v1h-1V3h1ZM8 5h1v1H8V5Zm1 2v1H8V7h1ZM8 9h1v1H8V9Zm2 0h1v1h-1V9Zm-1 2v1H8v-1h1Zm1 0h1v1h-1v-1Zm3-2v1h-1V9h1Zm-1 2h1v1h-1v-1Zm-2-4h1v1h-1V7Zm3 0v1h-1V7h1Zm-2-2v1h-1V5h1Zm1 0h1v1h-1V5Z"/>
        ...
        <div className="pane bg-mainbg col-span-5">
          ...
          <p className=" ml-7 mt-5  text-lg text-white font-medium ">
            SSL certificate information<Tooltip content={
      <div className="w-80">
        <Typography color="white" className="font-medium">SSL certificate information</Typography>
        <Typography
          variant="small"
          color="white" 
          className="font-normal opacity-80"
        >
          Know the status of SSL certificate of your web application
        </Typography>
      </div>
    }>
      ...
      />
          ...
          <div className="scan grid grid-cols-3 gap-2">
            ...
            <br></br>
            <p className=" ml-7 mt-5  text-lg text-white font-medium ">
              DNS record information<Tooltip content={
      <div className="w-80">
        <Typography color="white" className="font-medium">DNS record information</Typography>
        <Typography
          variant="small"
          color="white" 
          className="font-normal opacity-80"
        >
          Identify the DNS records associated with your domain
        </Typography>
      </div>
    }>
      <InformationCircleIcon 
      ...
      />
            ...
            <br></br>
            <p className=" ml-7 mt-5  text-lg text-white font-medium ">
              WHOIS information<Tooltip content={
      <div className="w-80">
        <Typography color="white" className="font-medium"> WHOIS information</Typography>
        <Typography
          variant="small"
          color="white" 
          className="font-normal opacity-80"
        >
          Know the WHOIS information of your registered domain
        </Typography>
      </div>
    }>
      <InformationCircleIcon 
