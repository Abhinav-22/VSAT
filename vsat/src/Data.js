    ...
    <>
      <div className="grid grid-cols-6 gap-0 h-full">
        ...
        <div className="pane bg-mainbg col-span-5">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="dta float-right mt-5 mr-2 text-white bi bi-shield-exclamation" viewBox="0 0 16 16">
