...
function Mainpage() {
        ...
        <div className="container my-24 px-6 mx-auto">
          <div className="flex justify-between lg:grid-cols-2 gap-8 xl:gap-16 items-center">
            <div className="mb-6 lg:mb-0">
              ...
              VSAT provides the platform that caters both individuals and organizations,<br>thus ensures security for everyone</br> 
              </p>
              <br />
              <div
                id="main"
              ...
              >
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-person my-auto" viewBox="0 0 16 16">
  <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0Zm4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4Zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10Z"/>
              ...
              <span className="my-auto ttspan ml-3 flex justify-center">
                ...
                <Link to="/login">
                <button className="flex bg-blue-500 hover:bg-blue-700 text-white font-bold text-left py-1 px-2 rounded h-10 mr-14">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-building my-auto" viewBox="0 0 16 16">
